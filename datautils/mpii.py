...
from .JointsDatasetmpii import JointsDataset


logger = logging.getLogger(__name__)

class MPIIDataset(JointsDataset):
    def __init__(self, cfg, root, image_set, is_train, transform=None, coord_representation='heatmap', simdr_split_ratio=2):
    ...
    def evaluate(self,preds, output_dir, *args, **kwargs):
        ...
        gt_file = os.path.join(INSERT_PATH_TO_train.json,
                               'annot',
                               'gt_valid.mat')
